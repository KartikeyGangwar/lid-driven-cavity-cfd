...
class LidDrivenCavitySolver:
    ...
    def create_plots(self, save_fig=True):
        ...
        ax2.plot(vortex_x, vortex_y, 'ro', markersize=8,
        ...
        ax3.plot(vortex_x, vortex_y, 'ro', markersize=8,
                markeredgecolor='white', markeredgewidth=2)
        ...
        # Mark vortex y-position
        ax4.axhline(y=vortex_y, color='r', linestyle='--', alpha=0.5,
                   label=f'Vortex y = {vortex_y:.3f}')
        ...
        # Mark vortex x-position
        ax5.axvline(x=vortex_x, color='b', linestyle='--', alpha=0.5,
                   label=f'Vortex x = {vortex_x:.3f}')
        ...
        contour6 = ax6.contourf(self.X, self.Y, self.p, levels=30, 
                               cmap='RdGy', alpha=0.9)
        ax6.plot(vortex_x, vortex_y, 'ro', markersize=8,
                markeredgecolor='white', markeredgewidth=2)
        ...
        plt.suptitle(f'Lid-Driven Cavity Flow | Re = {self.Re} | Grid = {self.N}×{self.N}\n'
                    f'Moving lid at top (y = {self.L}) | Vortex at (x={vortex_x:.3f}, y={vortex_y:.3f})', 
    ...
    def create_showcase_plots(self, save_fig=True):
        ...
        ax.axhline(
            ...
            linewidth=2,
            alpha=0.7,
            label=f"Vortex center (y = {vortex_y:.3f})"
        )
...
if __name__ == '__main__':
    ...
    N_GRID = 251        # Fine Grid size
    REYNOLDS = 1000     # High Reynolds number
    ...
    if converged or iterations == MAX_ITER:
        ...
        solver.create_showcase_plots(save_fig=True)
        solver.save_model()
